...
const FIELD_LABELS: Record<string, string> = {
  ...
  "guardrails.action.mode": "Guardrails Action Mode",
  "guardrails.result.mode": "Guardrails Result Mode",
  "guardrails.failClosed": "Guardrails Fail Closed",
  "guardrails.audit.enabled": "Guardrails Audit Enabled",
  "guardrails.audit.filePath": "Guardrails Audit File Path",
  "guardrails.audit.devConsole": "Guardrails Audit Dev Console",
  "guardrails.textguardrails.engine": "Text Guardrails Engine",
  "guardrails.textguardrails.nemo.endpoint": "NeMo Guardrails Endpoint",
  "guardrails.textguardrails.nemo.apiKey": "NeMo Guardrails API Key",
...
const FIELD_HELP: Record<string, string> = {
  ...
  "guardrails.action.mode":
    'OXCER: Pre-exec policy mode. "off" = skip; "warn" = log only; "enforce" = apply allow/deny/needs_human.',
  "guardrails.result.mode":
    'OXCER: Post-exec result policy mode. "off" = skip; "warn" = log only; "enforce" = redact on deny.',
  "guardrails.failClosed":
    "OXCER: When true, treat guardrail check errors as deny (block execution).",
  "guardrails.audit.enabled":
    "OXCER: If false, no JSONL audit file is written. Default: true. Supports compliance and forensics.",
  "guardrails.audit.filePath":
    "OXCER: Override for append-only audit JSONL file. Default: $OPENCLAW_STATE_DIR/audit/actions.jsonl.",
  "guardrails.audit.devConsole":
    "OXCER: When true, also log each audit event to console.debug (useful in dev).",
  "guardrails.textguardrails.engine":
    'OXCER: Text guardrails engine selector. "noop" = no external calls (default); "nemo" = NeMo Guardrails service.',
  "guardrails.textguardrails.nemo.endpoint":
    "OXCER: NeMo Guardrails service endpoint URL (e.g., http://localhost:8080). Required when engine is 'nemo'.",
  "guardrails.textguardrails.nemo.apiKey":
    "OXCER: Optional API key for NeMo Guardrails service authentication (for future use).",
