...
import { setGuardrailAuditConfig } from "../guardrails/audit.js";
...
export async function startGatewayServer(
  ...
  setGuardrailAuditConfig(resolveGuardrailsAuditConfig(cfgAtStart, STATE_DIR));
  ...
  const deps = {
    ...createDefaultDeps(),
    guardrailOrchestrator: createGuardrailOrchestrator(cfgAtStart),
  };
