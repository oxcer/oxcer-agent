...
export function createOpenClawCodingTools(options?: {
  ...
  guardrailOrchestrator?: import("../guardrails/orchestrator.js").GuardrailOrchestrator;
}): AnyAgentTool[] {
  ...
  const guardrailsConfig = resolveGuardrailsConfig(options?.config);
  const execTool = createExecTool({
    ...execDefaults,
    guardrailOrchestrator: options?.guardrailOrchestrator,
    guardrailsConfig,
