  ...
  try {
    ...
    const toolsRaw = params.disableTools
      ...
      : createOpenClawCodingTools({
          ...
          modelHasVision,
          guardrailOrchestrator: params.guardrailOrchestrator,
        });
    ...
    try {
      ...
      try {
        ...
        try {
          ...
          // OXCER: guardrail hook entry (pre-LLM prompt check)
          void params.guardrailOrchestrator
            ?.checkPrompt({
              messages: activeSession.messages,
              context: { sessionKey: params.sessionKey, agentId: params.sessionKey?.split(":")[0] },
            })
            .catch(() => {});
